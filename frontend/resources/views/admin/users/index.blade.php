<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg">
        <x-navbars.navs.auth titlePage="Kelola User"></x-navbars.navs.auth>
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center px-3">
                                ...
                                <a href="{{ route('admin.users.create') }}" class="btn btn-sm btn-white mb-0">
                                    <i class="material-icons text-sm me-1">add</i> Tambah User
                                </a>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('admin.users.show', $user['_id']) }}" class="text-info font-weight-bold text-xs me-2" title="Detail">
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-center py-4">
                                                <p class="text-secondary text-sm mb-0">Belum ada data user.</p>
                                            </td>
                                        </tr>
                                        @endforelse
                                    </tbody>
